    ...
    def run(self, args):
        ...
        with redirected_stdo(self.client.conn):
            for host in hosts:
                ...
                self.client.conn.modules["pupyutils.smbexec"].connect(host, args.port, args.user, args.passwd, args.hash, args.share, file_to_upload, remote_path, dst_folder, args.command, args.domain, args.execm)
