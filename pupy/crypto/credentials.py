...
# This file should contains the credentials your payloads' transports needs.
# These credentials will be embedded depending on which transport you use when you generate payloads with pupygen.py
# If pupygen.py doesn't find your credentials here, it will use default ones

#SCRAMBLESUIT_PASSWD="th!s_iS_pupy_sct_k3y"

#BIND_PAYLOADS_PASSWORD="PuPyD3f4ultP4sSw0rd"
