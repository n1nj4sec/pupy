...
RUN echo 'deb http://ftp.debian.org/debian stretch-backports main' >>/etc/apt/sources.list && \
    ...
    john vim-tiny less osslsigncode nmap net-tools libmagic1 swig \
...
ADD https://github.com/gentilkiwi/mimikatz/releases/download/2.2.0-20190504/mimikatz_trunk.zip \
